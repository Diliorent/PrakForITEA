...
//          std::cout << "Player 2 won!\n";
    ...
    std::cout << "|---------------------|" << std::endl << "|   Player1 wins:  " << win1 << "  |" << std::endl
              << "|   Player2 wins:  " << win2 << "  |" << std::endl << "|---------------------|" << std::endl;
    if (win1 > win2)
        std::cout << "______Player1 won!_____" << std::endl;
    if (win1 < win2)
        std::cout << "______Player2 won!_____" << std::endl;
    if (win1 == win2)
        std::cout << "_________Draw!_________";
